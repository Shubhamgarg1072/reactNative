...
// 1. Updated Type: We expect 'place', not 'item'
...
const DetailScreen = () => {
  ...
  // 2. FIXED: Grab 'place' from params, but call it 'item' so your JSX below works
    ...
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.bookButton}>
          ...
          <Ionicons name="paper-plane-outline" size={20} color="#fff" style={{ marginLeft: 10, transform: [{ rotate: '45deg' }] }} />
        </TouchableOpacity>
      </View>
